...
//             {this.state.title ? this.state.title : 'Choose a restaurant'}</div>
//           <div className='arrow_picker'>
//             <div className='arrow_picker-up'></div>
//             <div className='arrow_picker-down'></div>
//           </div>  
...
//           {this.state.title && !this.state.display ? (<button onClick={this.gotToRestaurant} > Got to the restaurant</button>
//           ) :null}
//       </div>
//    );  
//   }
